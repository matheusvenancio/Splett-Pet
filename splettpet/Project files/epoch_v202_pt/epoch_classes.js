...
function Epoch(name,mode,targetelement,multiselect) {
	...
	*/
	function setLang() {
		self.daylist = new Array('Dom','Seg','Ter','Qua','Qui','Sex','Sáb','Dom','Seg','Ter','Qua','Qui','Sex','Sáb');
		self.months_sh = new Array('Jan','Fev','Mar','Abr','Mai','Jun','Jul','Ago','Set','Out','Nov','Dez');
		self.monthup_title = 'Ir para o próximo mês';
		self.monthdn_title = 'Ir para o mês anterior';
		self.clearbtn_caption = 'Limpar';
		self.clearbtn_title = 'Limpa todas as datas seleccionadas no calendário';
		self.maxrange_caption = 'Este é o limite máximo';
		self.closebtn_caption = 'Feche';
		self.closebtn_title = 'Feche o calendário';
	}
	//-----------------------------------------------------------------------------
	/**
